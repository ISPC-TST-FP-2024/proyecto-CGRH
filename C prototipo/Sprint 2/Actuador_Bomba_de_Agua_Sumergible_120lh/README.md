...
## Descripción general:  
La bomba de agua sumergible de 120 litros por hora (L/h) es un dispositivo compacto y eficiente, diseñado para mover agua en aplicaciones de pequeño caudal, como fuentes, acuarios, sistemas de riego pequeños o circuitos de refrigeración. Funciona sumergida en agua y utiliza un pequeño motor eléctrico para generar flujo. Es ideal para proyectos que requieren un flujo continuo y estable de agua con bajo consumo energético.  

## Especificaciones técnicas principales:  
●Voltaje de operación: 3V - 6V  
●Consumo de energía: Aproximadamente 2W  
●Caudal máximo: 120 L/h  
●Altura máxima de elevación: 0.6 - 1 metro  
●Diámetro de la salida de agua: 6 - 8 mm  
●Modo de operación: Sumergible  
●Ruido: Bajo  

## Conexión de la bomba de agua sumergible:  

Bomba (+)---------Fuente (+)	Alimentación positiva de la bomba  
Bomba (-)---------Fuente (-)	Alimentación Masa de la bomba  

## Preguntas para verificar las pruebas de funcionamiento y efectividad:  
¿La bomba está recibiendo la potencia adecuada?  

¿El caudal de agua es constante y coincide con las especificaciones?  

¿Se activa la bomba correctamente desde el microcontrolador?

¿Es suficiente la altura máxima de elevación del agua?

¿El consumo de energía es bajo y acorde a las especificaciones?  

¿Funciona correctamente cuando está sumergida durante largos periodos de tiempo?
